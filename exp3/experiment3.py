...
class Experiment3App(App):
    ...
    def submit(self,s1,s2,s3,s4,s5,s6,mainimg,img1,img2,img3,img4,img5,img6,img7,img8,imgname,btnimg1,btnimg2,btnimg3,btnimg4,btnimg5,btnimg6,btnimg7,btnimg8):
        ...
        def load_images():
            ...
            self.test_img(img1,btnimg1,'./'+folder+'/' +'FilteredImage.jpg')
            self.test_img(img2,btnimg2,'./'+folder+'/' +'out_hist_afterfilter band '+str(int(s1.value))+'.jpg')
            self.test_img(img3,btnimg3,'./'+folder+'/' +'out_hist_afterfilter band '+str(int(s2.value))+'.jpg')
            self.test_img(img4,btnimg4,'./'+folder+'/' +'out_hist_afterfilter band '+str(int(s3.value))+'.jpg')
...
#uncomment the next line to run experiment3 directly
#Experiment3App().run()
