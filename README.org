...
The setup file provided fix for this error,hence this error will not occur if it is installed through setup.\\

- Open scilab,the initial screen should be as shown belo
